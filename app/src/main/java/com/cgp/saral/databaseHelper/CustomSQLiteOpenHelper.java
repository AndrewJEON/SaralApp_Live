...
public class CustomSQLiteOpenHelper extends SQLiteOpenHelper{
    ...
    private static final String DATABASE_NAME = "saral_app.sqlite";
    ...
    synchronized static public CustomSQLiteOpenHelper getInstance(Context context) {
        if (mInstance == null) {
