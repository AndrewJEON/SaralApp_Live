...
/**
 * Created by karamjeetsingh on 25/09/15.
 */
public class testcompass extends View {
    ...
    public testcompass(Context context) {
        super(context);
        initCompassView();
    }

    public testcompass(Context context, AttributeSet attrs) {
        super(context, attrs);
        initCompassView();
    }
    ...
    protected void initCompassView() {
        ...
        circlePaint.setColor(getResources().getColor(R.color.edittext));
        circlePaint.setStrokeWidth(1);
        circlePaint.setStyle(Paint.Style.STROKE);

        textPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        textPaint.setColor(r.getColor(R.color.green));
        ...
        markerPaint.setColor(r.getColor(R.color.red));//marker
        markerPaint.setAlpha(200);
        markerPaint.setStrokeWidth(1);
        markerPaint.setStyle(Paint.Style.STROKE);
        markerPaint.setShadowLayer(2, 1, 1, r.getColor(R.color.textColor_black));//shadow_color

        borderGradientColors = new int[4];
        borderGradientPositions = new float[4];

        borderGradientColors[3] = r.getColor(R.color.blue);//outer_border
        borderGradientColors[2] = r.getColor(R.color.red);//inner_border_one
        borderGradientColors[1] = r.getColor(R.color.green);//inner_border_two
        borderGradientColors[0] = r.getColor(R.color.text_white);//inner_border
        ...
        skyHorizonColorFrom = r.getColor(R.color.blue);//horizon_sky_from
        skyHorizonColorTo = r.getColor(R.color.background);//horizon_sky_to

        groundHorizonColorFrom = r.getColor(R.color.red);//horizon_ground_from
        groundHorizonColorTo = r.getColor(R.color.green);//horizon_ground_to
    }
