...
/**
 * Created by WeeSync on 17-04-2015.
 */
public class ChatAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        strMsg=chatMessage.getMessage();
        holder.txtMessage.setMovementMethod(LinkMovementMethod.getInstance());
        holder.txtMessage.setText(Html.fromHtml(strMsg));

       /* if(strMsg.contains("http://"))
        {
...
*/
    ...
    private void setAlignment(ViewHolder holder, boolean isMe) {
        if (!isMe) {
            ...
            holder.contentWithBG.setBackgroundResource(R.drawable.out_message_bg);//   change out massege icon
